<template>
  <div class="page-wrapper">
    ...
    <div class="demo-card">
      ...
      <div class="code-block mt-3">
        <div class="code-bar"><span class="code-badge">HTML</span>
          <button class="copy-btn" @click="copy('editor', codes.editor)"><i class="bi bi-clipboard me-1"></i>{{ copied==='editor'?'Copied!':'Copy' }}</button>
        </div>
    ...
    <div class="demo-card">
      ...
      <div class="code-block mt-3">
        <div class="code-bar"><span class="code-badge">HTML</span>
          <button class="copy-btn" @click="copy('textarea', codes.textarea)"><i class="bi bi-clipboard me-1"></i>{{ copied==='textarea'?'Copied!':'Copy' }}</button>
        </div>
...
<div contenteditable="true" class="editor-body">
  Start typing here...
</div>`,

  textarea: `<textarea class="form-control" rows="6" placeholder="Write your content here..."></textarea>

<!-- With Vue character count -->
...
@media (max-width: 576px) { .page-wrapper { padding: 16px; } .tb-sep { display: none; } }
</style>
