<template>
  <div class="page-wrapper">
    <div class="page-header">
      ...
      <p class="page-subtitle">Bootstrap 5 client-side form validation with Vue 3 reactive state.</p>
    </div>

    <!-- Custom Validation -->
    <div class="demo-card">
      <h6 class="demo-title">Custom Validation Styles</h6>
      <p class="demo-desc">Add <code>.was-validated</code> to the form to trigger validation feedback on all fields.</p>
      <div class="demo-box">
          ...
          <div class="row g-3">
            <div class="col-12 col-md-6">
              ...
              <input v-model="form.firstName" type="text" class="form-control"
                :class="submitted ? (form.firstName ? 'is-valid' : 'is-invalid') : ''" placeholder="John" required />
            ...
            <div class="col-12 col-md-6">
              ...
              <input v-model="form.lastName" type="text" class="form-control"
                :class="submitted ? (form.lastName ? 'is-valid' : 'is-invalid') : ''" placeholder="Doe" required />
              <div class="valid-feedback">Looks good!</div>
            ...
            <div class="col-12">
              ...
              <input v-model="form.email" type="email" class="form-control"
                :class="submitted ? (isValidEmail ? 'is-valid' : 'is-invalid') : ''" placeholder="john@example.com" required />
              <div class="valid-feedback">Looks good!</div>
            ...
            <div class="col-12 col-md-6">
              ...
              <input v-model="form.password" type="password" class="form-control"
                :class="submitted ? (form.password.length >= 6 ? 'is-valid' : 'is-invalid') : ''" placeholder="Min. 6 characters" required />
              <div class="valid-feedback">Looks good!</div>
        ...
        <div v-if="submitted && isFormValid" class="alert alert-success mt-3 mb-0">✓ Form submitted successfully!</div>
      </div>
    ...
    <div class="demo-card">
      <h6 class="demo-title">Inline Error Messages</h6>
      <p class="demo-desc">Use <code>.is-valid</code> and <code>.is-invalid</code> directly on inputs.</p>
      <div class="demo-box">
        <div class="row g-3">
          <div class="col-12 col-md-6">
...
const validationCode = `<form class="needs-validation" novalidate>
  <div class="row g-3">
    <div class="col-md-6">
...
const inlineCode = `<!-- Invalid state -->
<input type="text" class="form-control is-invalid" value="user@" />
<div class="invalid-feedback">Username can only contain letters and numbers.</div>
